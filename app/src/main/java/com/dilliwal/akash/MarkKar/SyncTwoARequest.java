 ...
 */
public class SyncTwoARequest extends StringRequest {
    private static final String MARK_REQUEST_URL = "https://akashdilliwal.000webhostapp.com/synctwoA.php";
    private Map<String,String> params;
    public SyncTwoARequest (int id,String attendanceDate,int rv,String absentDate,int absent,int present,String usern, Response.Listener<String> listener){
